...
var SywNamemap = map[string][]string{
	...
	"来歆余响":    {"魂香之花", "垂玉之叶", "祝祀之凭", "涌泉之盏", "浮溯之珏"},
	"沙上楼阁史话":  {"众王之都的开端", "黄金邦国的结末", "失落迷途的机芯", "迷醉长梦的守护", "流沙贵嗣的遗宝"},
	...
	"冰风迷途的勇士": {"历经风雪的思念", "摧冰而行的执望", "冰雪故园的终期", "遍结寒霜的傲骨", "破冰踏雪的回音"},
	"被怜爱的少女":  {"远方的少女之心", "少女飘摇的思念", "少女苦短的良辰", "少女片刻的闲暇", "少女易逝的芳颜"},
	"祭火之人":    {"", "", "", "", "祭火礼冠"},
	"绝缘之旗印":   {"明威之镡", "切落之羽", "雷云之笼", "绯花之壶", "华饰之兜"},
	"饰金之梦":    {"梦中的铁花", "裁断的翎羽", "沉金的岁月", "如蜜的终宴", "沙王的投影"},
	"乐园遗落之花":  {"月女的华彩", "谢落的筵席", "凝结的时刻", "守秘的魔瓶", "紫晶的花冠"},
}
